...
handoffs:
  ...
  - label: Report Findings
    ...
    prompt: Here is the synthetic analysis with systemic impact assessment. Use these insights to inform the master plan.
    send: true
---
<instruction>
...
**Hermeneutic Cycle** (Analysis-Synthesis-Collision-Conclusion):
...
**Output:** Root cause diagnosis → specific fix steps → systemic safety impact assessment
...
<example>
**Input:** "Why did adding tools to reasoning agents break semantic coherence?"
